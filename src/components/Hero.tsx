      ...
      <div className="section-container relative z-10">
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-semibold text-foreground leading-tight mb-6 text-balance">
            Senior <span className="whitespace-nowrap">Front-End</span> Architect & Developer
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8">
            26 years of software engineering experience designing large-scale front-end platforms.
          </p>
          <a 
            href="#contact"
